...
export default defineConfig({
  ...
  manifest: ({ browser }) => ({
    name: 'LeetGitSync',
    description: 'Save accepted LeetCode solutions directly to your GitHub repository.',
    ...
    content_security_policy: { extension_pages: "default-src 'none'; script-src 'self'; style-src 'self'; img-src 'self'; connect-src https://github.com https://api.github.com; object-src 'none'; base-uri 'none'; form-action 'none'; frame-ancestors 'none'" },
